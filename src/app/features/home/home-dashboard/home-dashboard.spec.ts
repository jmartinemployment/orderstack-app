...
function buildSetupTasks(
  ...
  return [
    { id: 'payments', label: 'Set up payments', description: 'Connect Stripe or PayPal to accept card payments', icon: 'bi-credit-card', route: '/settings', done: completedTasks.has('payments'), category: 'essential' },
