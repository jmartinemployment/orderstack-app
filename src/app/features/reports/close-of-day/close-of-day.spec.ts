...
describe('CloseOfDay — paymentBreakdown', () => {
  it('groups payments by method and sorts by total descending', () => {
    ...
    orders.set([
      makeOrder({
        ...
        checks: [{
          ...
          payments: [
            { guid: 'p-1', amount: 100, paymentProcessor: 'stripe', paymentMethod: 'credit', status: 'PAID' },
          ],
        } as unknown as Check],
      }),
      makeOrder({
        ...
        checks: [{
          ...
          selections: [], voidedSelections: [], discounts: [],
          payments: [
            { guid: 'p-2', amount: 50, paymentProcessor: 'stripe', paymentMethod: 'credit', status: 'PAID' },
          ],
        } as unknown as Check],
      }),
      makeOrder({
    ...
    // Stripe total = 150, Cash total = 30
    expect(breakdown[0].method).toBe('Card (Stripe)');
    ...
    orders.set([
      makeOrder({
        ...
        checks: [{
          guid: 'c-1', checkNumber: 1, subtotal: 90, totalAmount: 100,
          taxAmount: 8, discountAmount: 0, tipAmount: 15,
          payments: [{ guid: 'p-1', amount: 100, paymentProcessor: 'stripe', status: 'PAID' }],
      ...
      makeOrder({
        ...
        checks: [{
          ...
          payments: [{ guid: 'p-2', amount: 60, paymentProcessor: 'stripe', status: 'PAID' }],
          voidedSelections: [], discounts: [],
          selections: [
