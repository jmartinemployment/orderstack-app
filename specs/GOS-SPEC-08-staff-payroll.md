...
|-------|------|-------------|--------|
| Phase 1 | Steps 1-5 | Staff Management, Time Clock, Schedule Templates, Labor Cost Gauge, Notifications | ✅ COMPLETE |
| Phase 2 | Steps 6-10 | Payroll, Commissions, PTO, Onboarding | ✅ COMPLETE |
| Phase 3 | Steps 11-14 | Labor Forecasting, Compliance Dashboard | ✅ COMPLETE |

**Implemented in:** `orderstack-app/` (standalone Angular 21 SaaS)

**Depends on:** GOS-SPEC-01 (vertical-specific job titles, permission labels — FUTURE, not needed for restaurant-only features)
**Existing assets:** LaborService (29+ methods), StaffManagementService (52 methods), StaffScheduling (5 tabs), StaffPortal (4 tabs), WorkweekConfig, TimecardEditRequests, schedule enforcement, auto-clock-out
